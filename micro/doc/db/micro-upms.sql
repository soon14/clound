...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='日志表';

-- ----------------------------
-- Records of sys_log
-- ----------------------------
INSERT INTO `sys_log` VALUES ('1', '0', '添加用户', 'pig', 'admin', '2019-01-16 08:50:14', null, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.102 Safari/537.36', '/user', 'POST', '', '186', '0', null);
INSERT INTO `sys_log` VALUES ('2', '0', '删除用户token', 'pig', 'admin', '2019-01-16 08:51:23', null, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.102 Safari/537.36', '/token/bca7f867-2f80-46c3-a2ab-5e440a2d077e', 'DELETE', '', '18', '0', null);
INSERT INTO `sys_log` VALUES ('3', '0', '添加终端', 'pig', 'admin', '2019-01-16 09:50:01', null, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.102 Safari/537.36', '/client', 'POST', '', '400', '0', null);
INSERT INTO `sys_log` VALUES ('4', '0', '添加终端', 'pig', 'admin', '2019-01-16 09:56:58', null, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.102 Safari/537.36', '/client', 'POST', '', '60', '0', null);
INSERT INTO `sys_log` VALUES ('5', '0', '更新菜单', 'ygnet', 'admin', '2019-01-16 10:39:56', null, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.102 Safari/537.36', '/menu', 'PUT', '', '192', '0', null);
INSERT INTO `sys_log` VALUES ('6', '0', '删除终端', 'ygnet', 'admin', '2019-01-16 10:42:49', null, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.102 Safari/537.36', '/client/pig', 'DELETE', '', '205', '0', null);
INSERT INTO `sys_log` VALUES ('7', '0', '删除终端', 'ygnet', 'admin', '2019-01-16 10:42:56', null, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.102 Safari/537.36', '/client/app', 'DELETE', '', '107', '0', null);
...
INSERT INTO `sys_menu` VALUES ('3200', '接口文档', null, 'http://localhost:9999/swagger-ui.html', '3000', 'icon-wendang', null, '1', '0', '0', '2018-06-26 10:50:32', '2018-09-28 09:05:16', '0');
...
INSERT INTO `sys_menu` VALUES ('5000', '多级菜单', null, '/crud', '-1', 'icon-caidanguanli', '', '4', '0', '0', '2018-08-28 01:50:22', '2018-09-28 08:58:20', '0');
...
INSERT INTO `sys_menu` VALUES ('5003', '一级菜单', null, '', '5000', 'icon-caidanguanli', '', '1', '0', '0', '2018-11-21 17:49:18', '2018-11-21 17:53:25', '0');
...
INSERT INTO `sys_menu` VALUES ('6000', '系统官网', null, 'https://pig4cloud.com#', '-1', 'icon-guanwang', '', '5', '0', '0', '2018-09-27 02:26:36', '2018-11-17 16:18:50', '1');
...
-- ----------------------------
INSERT INTO `sys_oauth_client_details` VALUES ('activiti', '', 'activiti', 'server', 'password,refresh_token', '', '', null, null, '', 'true');
...
INSERT INTO `sys_oauth_client_details` VALUES ('ygnet', '', 'sunshine', 'server', 'password,refresh_token,authorization_code', '', '', null, null, '', 'true');
...
-- ----------------------------
INSERT INTO `sys_route_conf` VALUES ('1', '工作流管理模块', 'micro-activiti', '[{\"args\": {\"_genkey_0\": \"/act/**\"}, \"name\": \"Path\"}]', '[]', 'lb://micro-activiti', '0', '2018-11-28 15:56:10', '2019-01-15 16:48:10', '0');
INSERT INTO `sys_route_conf` VALUES ('2', '认证中心', 'micro-auth', '[{\"args\": {\"_genkey_0\": \"/auth/**\"}, \"name\": \"Path\"}]', '[{\"args\": {}, \"name\": \"ValidateCodeGatewayFilter\"}, {\"args\": {}, \"name\": \"PasswordDecoderFilter\"}]', 'lb://micro-auth', '0', '2018-11-28 15:56:10', '2019-01-15 16:48:12', '0');
INSERT INTO `sys_route_conf` VALUES ('3', '代码生成模块', 'micro-codegen', '[{\"args\": {\"_genkey_0\": \"/gen/**\"}, \"name\": \"Path\"}]', '[]', 'lb://micro-codegen', '0', '2018-11-28 15:56:10', '2019-01-15 16:48:15', '0');
INSERT INTO `sys_route_conf` VALUES ('4', '定时任务模块', 'micro-daemon', '[{\"args\": {\"_genkey_0\": \"/daemon/**\"}, \"name\": \"Path\"}]', '[]', 'lb://micro-daemon', '0', '2018-11-28 15:56:10', '2019-01-15 16:48:18', '0');
INSERT INTO `sys_route_conf` VALUES ('5', '分布式事务模块', 'micro-tx-manager', '[{\"args\": {\"_genkey_0\": \"/tx/**\"}, \"name\": \"Path\"}]', '[]', 'lb://micro-tx-manager', '0', '2018-11-28 15:56:10', '2019-01-15 16:48:22', '0');
INSERT INTO `sys_route_conf` VALUES ('6', '通用权限模块', 'upms-biz', '[{\"args\": {\"_genkey_0\": \"/admin/**\"}, \"name\": \"Path\"}]', '[{\"args\": {\"key-resolver\": \"#{@remoteAddrKeyResolver}\", \"redis-rate-limiter.burstCapacity\": \"20\", \"redis-rate-limiter.replenishRate\": \"10\"}, \"name\": \"RequestRateLimiter\"}, {\"args\": {\"name\": \"default\", \"fallbackUri\": \"forward:/fallback\"}, \"name\": \"Hystrix\"}]', 'lb://upms-biz', '0', '2018-11-28 15:56:10', '2019-01-15 16:48:28', '0');
...
INSERT INTO `sys_user` VALUES ('3', 'wsj', '$2a$10$xuWZByctIPim93f937mG.uajNnYZYYz.IKierSb/fB/tnyHAQaXwm', null, '', null, '5', '2019-01-16 08:50:14', null, '0', '0', null, null);
