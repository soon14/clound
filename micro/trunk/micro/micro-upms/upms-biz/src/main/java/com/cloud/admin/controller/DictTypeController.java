...
public class DictTypeController {
    ...
    public R<IPage> getDictPage(Page page, SysDictType sysDictType) {
        return new R<>(sysDictTypeService.page(page,
                Wrappers.query(new SysDictType())
                        .like(StringUtils.isNotBlank(sysDictType.getInnerFlag()), SysDictType::getInnerFlag, sysDictType.getInnerFlag())
                        .like(StringUtils.isNotBlank(sysDictType.getChineseName()), SysDictType::getChineseName, sysDictType.getChineseName())
                        .eq(StringUtils.isNotBlank(sysDictType.getIsTree()), SysDictType::getIsTree, sysDictType.getIsTree())
        ));
    }
