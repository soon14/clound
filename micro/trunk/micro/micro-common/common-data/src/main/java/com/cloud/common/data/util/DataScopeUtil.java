...
public class DataScopeUtil {
     ...
     * @return
     */
    public String getDataScopeSql(String scopeName, String permission) {
        return getDataScopeSql(new DataScope(scopeName, permission));
    }
     ...
     * @return
     */
    public String getDataScopeSql(String scopeName, String permission, String userScopeName) {
        return getDataScopeSql(new DataScope(scopeName, permission, userScopeName));
    }
     ...
     */
    public String getDataScopeSql(String scopeName, String permission, String userScopeName, boolean andOr) {
        return getDataScopeSql(new DataScope(scopeName, permission, userScopeName, andOr));
    }
