...
public class SysFileServiceImpl extends ServiceImpl<SysFileMapper, SysFile> implements SysFileService {
   ...
   /* @Value("${sys.files.path}")
    ...
    public Map<String, Object> upload(MultipartHttpServletRequest multipartRequest, SysFile sysFile) throws Exception {
        ...
        // id+扩展名
        // String tmpName = id + sysFile.getExtName();
        // 根据时间产生对应年份月份文件夹
        // String targetDir = filePath + "\\" + DateUtils.getYear() + "\\"  + Integer.valueOf(DateUtils.getMonth());
        //  sysFile.setPath(targetDir + "\\" + tmpName);
