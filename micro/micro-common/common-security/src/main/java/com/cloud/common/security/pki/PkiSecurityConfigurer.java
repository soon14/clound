...
public class PkiSecurityConfigurer extends SecurityConfigurerAdapter<DefaultSecurityFilterChain, HttpSecurity> {
	...
	public void configure(HttpSecurity http) {
		...
		pkiAuthenticationFilter.setAuthenticationSuccessHandler(mobileLoginSuccessHandler);
		...
		PkiAuthenticationProvider mobileAuthenticationProvider = new PkiAuthenticationProvider();
