...
@Slf4j
@AllArgsConstructor
public class MicroFeignFallbackMethod implements MethodInterceptor {
	private Class<?> type;
	...
	public Object intercept(Object o, Method method, Object[] objects, MethodProxy methodProxy) {
		...
		if (R.class == method.getReturnType()) {
			final R result = cause instanceof MicroFeignException ?
					((MicroFeignException) cause).getResult() : R.builder()
