...
<script>
    ...
    export default {
            ...
            return {
                ...
                option:{
                    ...
                    column:[
                        ...
                        {  label:"行业类型", prop:"gxhylx", search:true ,type: 'tree',
                        ...
                        {  label:"管辖单位", prop:"departmentCode",
        ...
        created(){
            ...
            this.option.column[4].searchDefault=this.searchForm.orgCode
        ...
        methods:{
            ...
            searchChange(form) {
                ...
                this.searchForm.placeType= form.gxhylx
