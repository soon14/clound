...
<script>
    import {fetchArea,fetchHylx,fetchJfdj} from '@/api/portal/archive/common-query/query'
    ...
    export default {
        ...
        methods: {
            ...
            getDomHeight(){
                this.height=document.querySelector(".page-common-query").offsetHeight;
                let contentHeight=this.height-160-100;
                let contentChildHeight=document.querySelector(".el-form-s").offsetHeight;
                if(contentChildHeight <= contentHeight){
                    document.querySelector(".query-checkbox").style.height = contentChildHeight+20+'px';
                }else{
                    document.querySelector(".query-checkbox").style.height = contentHeight+'px';
                }
