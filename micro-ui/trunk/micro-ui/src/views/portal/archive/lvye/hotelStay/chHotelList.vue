<template>
    ...
    <basic-container>
        ...
        <el-dialog title="人员详情"  :visible.sync="chFormView" :fullscreen="true" :append-to-body="true">
            <avue-detail :option="chFormOption" v-model="chFromDetail">
            </avue-detail>
            <div slot="footer"
                 class="dialog-footer">
                <el-button type="primary" @click="chFormView=false">关 闭
                </el-button>
            </div>
        </el-dialog>
    </basic-container>
...
<script>
    ...
    import {chOptionDetail}  from  "@/const/crud/portal/archive/lvye/routineCheck";
    ...
    export default {
        ...
        methods: {
            viewDialog(row){
                this.chFormView=true
                this.chFromDetail=row
            },
