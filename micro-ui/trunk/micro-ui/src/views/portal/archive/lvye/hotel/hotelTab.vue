...
<script>
    ...
    import  ch_List from '../hotelStay/chHotelList'
    import  hk_List from '../hotelStay/hkHotelList'
    import  fo_List from '../hotelStay/foHotelList'
    ...
    export default {
        ...
        data () {
            ...
            return{
                selected:0,
                tabData:[
                    {name:"单位信息",icontfont:"alzhengjianxinxi",tabView:"detail"},
                    {name:"从业人员",icontfont:"alcongyerenyuan",tabView:"employee"},
                    {name:"国内旅客",icontfont:"alyidengjihetongpifu",tabView:"ch_List"},
                    {name:"港澳台旅客",icontfont:"alyidengjihetongpifu",tabView:"hk_List"},
                    {name:"国外旅客",icontfont:"alyidengjihetongpifu",tabView:"fo_List"},
                    {name:"日常检查",icontfont:"alzhian",tabView:"routineCheck"},
                    {name:"视频监控",icontfont:"alshipin",tabView:"employee"},
                    ],
                currentView:"detail",
                actives: 'detail',
                searchForm: {
