<template>
    ...
    <basic-container>
        ...
        <el-dialog title="人员详情"  :visible.sync="foFormView" :fullscreen="true" :append-to-body="true">
            <avue-detail :option="foFormOption" v-model="foFromDetail">
            </avue-detail>
            <div slot="footer"
                 class="dialog-footer">
                <el-button type="primary" @click="foFormView=false">关 闭
                </el-button>
            </div>
        </el-dialog>
    </basic-container>
...
<script>
    ...
    import {foFormOption}  from  "@/const/crud/portal/archive/lvye/routineCheck";
    export default {
        name: "hkHotelList",
        props:["paramForm"],
        data() {
        ...
        methods: {
            viewDialog(row){
                this.foFormView=true
                this.foFromDetail=row
            },
