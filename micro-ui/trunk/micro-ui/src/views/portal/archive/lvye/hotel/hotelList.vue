    ...
    export default {
        ...
        methods: {
            ...
            initDefaultValue(){
                ...
                setTimeout(() => {
                    try{
                        this.$refs["crud"].searchForm.cityCode=this.searchForm.orgCode
                    }catch (e) {}
                }, 1500);
            },
            ...
            clearForm() {
                try{
                    this.$refs["crud"].searchForm.hname=undefined
                    this.$refs["crud"].searchForm.cityCode=undefined
            ...
            searchChange(form) {
                    ...
                    this.searchForm.placeType= form.hotelKind
            ...
            contact(row){
                ...
                this.contactForm.lyxtType='3'
                this.contactForm.qtdwbh=row.hnoHotel
                this.contactForm.dwmc=row.hname
                this.contactForm.hylx='01'
                this.contactForm.address=row.haddress
                this.contactForm.areaCode=row.cityCode
                this.contactForm.sspcs=row.psCode
            }
