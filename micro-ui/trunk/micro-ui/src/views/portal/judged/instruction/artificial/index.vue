<template>
    <div class="app-container calendar-list-container">
        ...
        <el-dialog title="查看" :visible.sync="showView"  :append-to-body="applyToBody" width="80%" :before-close="closeDialog">
            ...
            <span slot="footer"
                  class="dialog-footer">
                <el-button type="primary" @click="submitReply" v-if="isShowCommitBtn">提交</el-button>
...
<script>
    ...
    import artificialView from "./view";
    import {fetchTree,fetchTreelist} from "@/api/admin/dept";
    import {fetchArea} from '@/api/portal/archive/common/query.js';
    import {remote} from "@/api/admin/dict";
    import {findCurrentUserSendListPage,saveArtificialInstruction,delObj,saveReply,sendArtificialInstruction} from "@/api/portal/judged/instruction/instruction";
    ...
    export default {
        ...
        methods:{
            ...
            getList(page, params) {
                ...
                this.searchForm.createBy = this.userInfo.userId;
                this.searchForm.type = instructDict.INSTRUCTION_TYPE.ARTIFICIAL_INSTRUCTION_TYPE;
                findCurrentUserSendListPage(Object.assign({
