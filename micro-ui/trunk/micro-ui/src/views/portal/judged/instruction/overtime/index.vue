...
<script>
    ...
    import {findOvertimeListPage,saveArtificialInstruction,delObj,saveReply,sendArtificialInstruction} from "@/api/portal/judged/instruction/instruction";
    ...
    export default {
        ...
        methods:{
            ...
            getList(page, params) {
                ...
                findOvertimeListPage(Object.assign({
