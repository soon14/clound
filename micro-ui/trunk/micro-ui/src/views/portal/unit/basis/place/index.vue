    ...
    <div class="app-container calendar-list-container">
        <basic-container>
            <avue-crud :option="option" :data="data"
                ...
                <template slot="dwmc"
                          slot-scope="scope">
                    <button type="button" class="el-button el-button--text el-button--small"   @click="openUnitDialog(scope.row)">{{scope.row.dwmc}}</button>
                </template>
                <template slot="menu" slot-scope="scope">
                        ...
                        <el-button
                                ...
                                type="text"
                                icon="el-icon-view"
                                @click="openUnitDialog(scope.row)">预览
                        </el-button>
        ...
        <el-dialog :title="unitTitle" fullscreen :visible.sync="unitView"  >
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            openUnitDialog(row) {
                this.unitView = true
                this.unitTitle = row.dwmc
                if(row.dwlb==='17'){
                    this.optionTap.column[1].label='典当业'

                }else{
                    this.optionTap.column[1].label='旅馆业'
                }
                this.fromDetail.dwmc=row.dwmc
                this.fromBaseDetail.dwmc=row.dwmc
                this.fromBaseDetail.jymc=row.dwmc
