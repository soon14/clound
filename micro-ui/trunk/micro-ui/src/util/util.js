 ...
 * 根据字典的value显示label
 */
export const findLabelByValue = (dic, value) => {
  let result = ''
 ...
 * @param str
 * @param dicData
 * @param objOrStr 返回对象或者字符串 默认返回字符串
 */
export const findLabelByValues = (dicData,value,defVal,objOrStr)=>{
  ...
  for (let arr of array) {
    result.push(findLabelByValue(dicData, arr))
  }
  if (objOrStr == true) {
    return result
  } else {
